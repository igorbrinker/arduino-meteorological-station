...
const uint8_t intro[] PROGMEM= {
 ...
 0x0, 0x0, 0x0, 0x0, 0x0, 0x1f, 0xf8, 0x0, 0x0, 0x7f, 0xff, 0x0, 
  0x1, 0xff, 0x7f, 0x80, 0x3, 0xff, 0x7f, 0xc0, 0x7, 0xfc, 0x7f, 0xe0, 
  0xf, 0xf8, 0x3f, 0xf0, 0x1f, 0xe0, 0x7, 0xf8, 0x3f, 0xc0, 0x7, 0xfc, 
  0x3f, 0xd8, 0x3, 0xfc, 0x3f, 0x61, 0x81, 0xfc, 0x7e, 0x77, 0x83, 0xfe, 
  0x78, 0x7f, 0x3, 0x3e, 0x70, 0x3e, 0x3, 0x3e, 0x60, 0x3e, 0x3, 0x1e, 
  0x40, 0x1c, 0x2, 0xe, 0x40, 0x0, 0x0, 0x6, 0x0, 0x0, 0x0, 0x6, 
  0x0, 0x0, 0x0, 0x2, 0x0, 0x60, 0x0, 0x2, 0x1, 0xc0, 0xc, 0x2, 
  0x5, 0xc0, 0x1c, 0x0, 0x7, 0xc0, 0x3f, 0x0, 0x7, 0xc0, 0x3f, 0x0, 
  0x7, 0xc0, 0x3f, 0xc0, 0x7, 0xc0, 0x3f, 0xc0, 0x3, 0xc0, 0x3f, 0x80, 
  0x3, 0xe0, 0x3f, 0x80, 0x0, 0xe0, 0x3f, 0x0, 0x0, 0x30, 0x1c, 0x0, 
  0x0, 0x0, 0x0, 0x0,
};
...
u8g.print("%");
u8g.drawBitmapP( 0, 15, 6, 48,rain);

}

void draw_4(void){
pressure=bmp.readPressure()/100;
hum=(DHT.humidity,1)/1;
...
if ((pressure<=1000.59)&&(pressure>998.5)&&(hum>=60)&&(hum<73)){
u8g.drawBitmapP( 10, 15, 6, 48,cloudy);
u8g.setPrintPos(60,45);
u8g.print("Nublado");
}
else if((pressure<998.5)&&(pressure>996.5)&&(hum>=73))
{
u8g.drawBitmapP( 10, 15, 6, 48,rain);
u8g.setPrintPos(66,38);
u8g.print("Chuvoso");}
else if((pressure>1010.6)&&(pressure<1050)&&(hum<50))
{
u8g.drawBitmapP( 5, 15, 6, 48,sunny);
u8g.setPrintPos(50,45);
u8g.print("Ceu Limpo");}
else if((pressure>990)&&(pressure<=996.4)&&(hum>=75))
{
